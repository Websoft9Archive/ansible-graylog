...
| 服务器配置 | 最低1核4G，存储20GB以上，Swap分区2GB以上 |  建议采用按量100M带宽 |

更多请见： [官方 System requirement](https://docs.graylog.org/en/latest/pages/installation.html#system-requirements)。
...
```
wget -N https://ghproxy.com/https://raw.githubusercontent.com/Websoft9/ansible-linux/main/scripts/install.sh; bash install.sh -r graylog
```
...
本项目通过Docker 安装，请通过[官方URL](https://www.graylog.org/downloads)页面查看版本号。  
我们会定期检查[Release版本](https://github.com/Websoft9/ansible-graylog/releases)，更新并测试此项目，以保证用户可以顺利安装所需的graylog版本。 
